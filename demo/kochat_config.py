...
DATA = {
    ...
    'NER_categories': ['DATE', 'LOCATION', 'RESTAURANT', 'PLACE', 'KEYWORD'],  # 사용자 정의 태그
...
INTENT = {
    ...
    'distance_fallback_detection_criteria': 'mean',  # [auto, min, mean], auto는 OOD 데이터 있을때만 가능
    'distance_fallback_detection_threshold': 1.5,  # mean 혹은 min 선택시 임계값
