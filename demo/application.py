import sys
sys.path.append("/home/lbs/chat/kochat")
"""
@auther Hyunwoong
@since 7/1/2020
...
from demo.scenario import dust, weather, travel, restaurant, knu_info
...
kochat = KochatApi(
    ...
    scenarios=[
        weather, dust, travel, restaurant, knu_info
    ]
)
